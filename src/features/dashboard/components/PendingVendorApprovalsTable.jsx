...
import { Check, Eye, X, ArrowUpRight, LoaderCircle } from "lucide-react";
...
<div className="flex items-center justify-end gap-1">
  {isUpdating ? (
    ...
    <>
      <button aria-label={t("adminDashboard.approvals.viewDetails", { defaultValue: "View details" })} className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-[#f4efe9] text-[#6f655e] transition hover:bg-[#e9ddd3] hover:text-[#1f1711]" onClick={() => navigate(`/vendors/${approval.vendorId}/review`)} title={t("adminDashboard.approvals.viewDetails", { defaultValue: "View details" })} type="button"><Eye size={14} /></button>
      {approval.canApprove ? (
