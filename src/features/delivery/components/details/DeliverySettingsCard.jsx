...
function TextField({
  ...
  return (
    <label className="space-y-2">
      <p className="text-[12px] font-bold uppercase tracking-[0.08em] text-[#a39388]">{dt(label)}</p>
      {as === "select" ? (
        <select
  ...
  return (
    <section className="rounded-[22px] border border-[#ddd4cd] bg-[linear-gradient(180deg,#fffdfa_0%,#fff7f1_100%)] p-6 shadow-[0_16px_34px_rgba(55,31,13,0.06)]">
      <div className="mb-5 flex items-center justify-between gap-3">
        <div>
          <h2 className="text-[24px] font-bold tracking-[-0.03em] text-[#18120f]">{dt("General Settings")}</h2>
          <p className="mt-2 text-[15px] leading-6 text-[#6f645d]">{dt("Review the main delivery-area details and internal notes for this city.")}</p>
        </div>
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)]">
        ...
        <div className="rounded-[18px] border border-[#eadfd6] bg-white px-4 py-4">
          <p className="text-[11px] font-bold uppercase tracking-[0.12em] text-[#9b8f86]">{dt("Delivery Overview")}</p>
          <div className="mt-3 grid gap-3 sm:grid-cols-3">
            <div className="rounded-[14px] border border-[#f1e5dd] bg-[#fff9f5] px-3 py-3">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-[#a39388]">{dt("Coverage Type")}</p>
              <p className="mt-2 text-[14px] font-semibold text-[#18120f]">{dt(area.coverageType)}</p>
            </div>
            <div className="rounded-[14px] border border-[#f1e5dd] bg-[#fff9f5] px-3 py-3">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-[#a39388]">{dt("Postal Codes")}</p>
              <p className="mt-2 text-[14px] font-semibold text-[#18120f]">{area.activePostalCodes}</p>
            </div>
            <div className="rounded-[14px] border border-[#f1e5dd] bg-[#fff9f5] px-3 py-3">
              <p className="text-[11px] font-bold uppercase tracking-[0.08em] text-[#a39388]">{dt("Linked Vendors")}</p>
