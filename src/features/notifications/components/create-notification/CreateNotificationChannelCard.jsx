    ...
    >
      ...
      <span className="block">
        <span className="flex items-center gap-2">
          <span className="block text-[17px] font-bold tracking-[-0.01em] text-[#241913]">{nt(title)}</span>
          {badge ? (
        ...
        <span className="mt-1.5 block text-[14px] leading-6 text-[#8e8178]">{nt(description)}</span>
      </span>
    </button>
  );
}
