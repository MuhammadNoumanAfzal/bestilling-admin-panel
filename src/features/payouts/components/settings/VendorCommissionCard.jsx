...
function VendorAvatar({ label }) {
  return (
    <span className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[linear-gradient(135deg,#3b3028_0%,#9d6d3d_100%)] text-[9px] font-bold text-white">
      {label}
    </span>
  );
}

export default function VendorCommissionCard({ rows }) {
  return (
    <section className="overflow-hidden rounded-[16px] border border-[#d8ccc2] bg-white shadow-[0_10px_22px_rgba(56,33,17,0.04)]">
      <div className="flex items-center justify-between gap-3 px-4 py-4">
        <div className="flex items-center gap-2">
          <h2 className="text-[18px] font-bold text-[#221914]">Vendor Commission</h2>
        ...
        <table className="w-full border-collapse">
          <thead className="bg-[#fcfbfa]">
            <tr className="text-left">
              <th className="px-4 py-3 text-[11px] font-bold text-[#9b8f86]">Vendor</th>
              <th className="px-3 py-3 text-[11px] font-bold text-[#9b8f86]">Area</th>
              <th className="px-3 py-3 text-[11px] font-bold text-[#9b8f86]">Current Commission</th>
              ...
              <tr key={row.id} className="border-t border-[#f1e9e2]">
                <td className="px-4 py-3">
                  <div className="flex items-center gap-2.5">
                    <VendorAvatar label={row.avatar} />
                    <span className="text-[12px] font-semibold text-[#2a1e17]">{row.vendor}</span>
                  </div>
                </td>
                <td className="px-3 py-3 text-[12px] text-[#584c45]">{row.area}</td>
                <td className="px-3 py-3 text-[12px] font-bold text-[#2a1e17]">{row.currentCommission}</td>
