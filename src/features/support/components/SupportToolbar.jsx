...
export default function SupportToolbar({
  ...
  return (
    <div className="flex flex-col gap-4 border-b border-[#e7ddd5] px-4 py-4 sm:px-5">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex w-full items-center gap-2 md:w-auto md:self-auto">
          <button
            className={[
              "inline-flex h-9 flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-[10px] border px-3.5 text-[13px] font-semibold transition md:flex-none",
              isAllActive
