...
export default function VendorDetailStatCard({ id, label, value }) {
  ...
  return (
    <article className="rounded-[14px] border border-[#e8ddd5] bg-white px-4 py-4 shadow-[0_8px_18px_rgba(55,31,13,0.06)]">
      <div className="space-y-3">
        <span className="inline-flex h-9 w-9 items-center justify-center rounded-[10px] bg-[#fff3ec] text-[#d66b38]">
          <Icon size={16} />
        </span>
        <div>
